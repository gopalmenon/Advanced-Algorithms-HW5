...
\forall i \text{ } \sum_j k_{ij} &= 1  \label{onePerCust}\\
...
\item \eqref{onePerCust} says that for any customer, at most one binary variable $k_{ij}$ will be $1$. This will be used to ensure that for customer $i$, only the nearest store will be considered in \eqref{withinReach}.
